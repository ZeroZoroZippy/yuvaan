...
🔗 From: Portfolio Chatbot (GPT-4o-mini)
    `.trim();
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p style="font-size: 12px; color: #666; text-align: center;">
        Generated by Portfolio Chatbot (GPT-4o-mini) • Conversation ID: ${lead.conversationId}
      </p>
    </div>
  `;
};
...
app.listen(PORT, () => {
  ...
  console.log(`🤖 Chatbot API: ✅ Active with GPT-4o-mini (Fast & Efficient)`);
  ...
  console.log('\n🎯 Ready for both contact forms and chatbot leads with GPT-4o-mini!');
});
